...
#
# Usage:
#   ./scripts/test-possessives.sh              # test against localhost:8080 (requires AWS session)
#   ./scripts/test-possessives.sh --local      # test against localhost:8080 (no AWS needed)
